...
name = f"deep_ppo_v2_ext"
run = wandb.init(
    project="Real_Plant_PPO",
...
model = PPO.load("/home/nitesh/.local/share/ov/pkg/isaac-sim-4.0.0/maniRL/results/deep_ppo_v2/mybuddy_policy_checkpoint_50000_steps.zip", env=my_env, verbose=1)
